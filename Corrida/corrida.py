...
# Def que calcula a motivação da corrida, onde os números gerados pelo random tem que estar necessariamente entre os números 0.8 e 1.2, para que as probalbilidades finais sejam as esperadas
